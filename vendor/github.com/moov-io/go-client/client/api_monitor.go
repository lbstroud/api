...
/*
MonitorApiService Check that moov-io/ach service is running
...
/*
MonitorApiService Check that moov-io/auth service is running
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
MonitorApiService Check that moov-io/ofac service is running
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
*/
func (a *MonitorApiService) PingOFAC(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
