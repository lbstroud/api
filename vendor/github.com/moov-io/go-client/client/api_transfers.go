 ...
 * @param "StartDate2" (optional.Time) -  Filter objects created after this date. ISO-8601 format YYYY-MM-DD. Can optionally be used with endDate to specify a date range.
 ...
 * @param "EndDate2" (optional.Time) -  Filter objects created before this date. ISO-8601 format YYYY-MM-DD. Can optionally be used with startDate to specify a date range.
 * @param "XRequestId" (optional.String) -  Optional Request ID allows application developer to trace requests through the systems logs
@return []Transfer
*/
...
type GetTransfersOpts struct {
	...
	StartDate2 optional.Time
	EndDate    optional.Time
	EndDate2   optional.Time
	XRequestId optional.String
}
...
func (a *TransfersApiService) GetTransfers(ctx context.Context, localVarOptionals *GetTransfersOpts) ([]Transfer, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.StartDate2.IsSet() {
		localVarQueryParams.Add("startDate", parameterToString(localVarOptionals.StartDate2.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.EndDate2.IsSet() {
		localVarQueryParams.Add("endDate", parameterToString(localVarOptionals.EndDate2.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
